...
export function StudentProfile() {
  ...
  const [activeView, setActiveView] = useState<'profile' | 'recommendations' | 'jobs' | 'payments'>('profile');
          ...
          <div key={rec.id} className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 hover:shadow-md transition-shadow">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between pt-3 border-t border-slate-100">
                ...
                <button className="flex items-center gap-1 px-4 py-2 bg-blue-600 text-white rounded-lg text-sm font-medium hover:bg-blue-700 transition-colors">
                  Apply
      ...
      <div className="bg-gradient-to-br from-emerald-500 to-teal-600 rounded-xl shadow-lg p-8 text-white">
        <div className="flex items-start justify-between">
          <div>
            ...
            <h2 className="text-4xl font-bold">${(student?.total_earnings || 2450).toLocaleString()}</h2>
            <p className="text-emerald-100 mt-4">Pending: $280.00</p>
          </div>
